...
function AuthenticatePage() {
  return (
    <section className="mt-[7em] w-[60%] max-sm:ml-[0.01em]max-sm:w-[100%] max-mad:w-[98%] ml-[30em] max-md:ml-[3.5em] overflow-hidden "> 
         <h2 className="font-sans font-bold text-center text-[2.5rem]">Welcome Back!</h2>
